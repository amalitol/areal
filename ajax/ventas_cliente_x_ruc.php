 ...
 * $.ajax() 
 */
/* Archivo que permite mediante AJAX buscar los datos del cliente al cual voy a hacerle la nueva venta de acuerdo a su RUC y los muestro en un <div> para poder continuar .... del módulo VENTAS -> NUEVA VENTA */
...
//01 RECIBO LAS VARIABLES $_GET.
	 ...
	 $ruc_cliente    =  $_GET['ruc_cliente'];    // ruc DEL CLIENTE PARA BUSCAR LOS DATOS EN LA TABLA. 

//02 REALIZO LA CONSULTA EN LA BASE DE DATOS PARA OBTENER LOS DATOS
     
	    $query1 = "SELECT * FROM proveedores_clientes WHERE active_cliente=1 AND ruc='".$ruc_cliente."' AND ruc!=''";
